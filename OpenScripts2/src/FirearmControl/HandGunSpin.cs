...
{
    [Obsolete("Use PhysicalObjectSpin instead! It literally does the same but for any physical object. I just made this script first lol")]
    public class HandgunSpin : PhysicalObjectSpin
    {
        ...
        //        {
        //            handgunSpin.ScaleColliderDown(self);
        //        }
        //    }
        //    orig(self, hand);
        //}
        ...
        //        if (OpenScripts2_BepInExPlugin.SpinGrabHelper.Value && handgunSpin._isSpinning)
        //        {
        //            handgunSpin.ScaleColliderUp(self);
        //        }
        //    }
