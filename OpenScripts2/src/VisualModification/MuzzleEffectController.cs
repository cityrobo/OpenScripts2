...
{
    public class MuzzleEffectController : OpenScripts2_BasePlugin
    {
		...
		public void Awake()
        {
			...
			{
				LogError($"MuzzleEffects list length ({MuzzleEffects.Length}) not equal to SuppressedMuzzleEffectSizes list length ({SuppressedMuzzleEffectSizes.Length})! ABORTING!!!");
				Destroy(this);
			}
