...
namespace OpenScripts2
{
    ...
    {
        [Header("Don't forget to use the Context Menu to create the joint chain!")]
        public FVRPhysicalObject MainObject;
        public Transform RootBone;
        [Tooltip("Will get disabled on start. Should only contain the reference used for the joint chain creation.")]
